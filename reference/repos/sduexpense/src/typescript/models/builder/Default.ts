...
export default class Default {
    ...
    tsxShowHelperText: any = () => { console.log('[UNSET] tsxShowHelperText') };
    ...
    _key: any;
    key(key: any) { this._key = key; return this; }
    ...
    disabled(v?: any) { this._disabled = v === undefined ? true : !!v; return this; }
    ...
    hidden(v?: boolean) { this._hidden = v === undefined ? true : v; return this; }
