...
var Default = /** @class */ (function () {
    function Default(_class) {
        ...
        /** */
        this.tsxShowHelperText = function () { console.log('[UNSET] tsxShowHelperText'); };
    ...
    Default.prototype.disabled = function (v) { this._disabled = v === undefined ? true : !!v; return this; };
    ...
    Default.prototype["default"] = function (v) {
        ...
        this._default = v;
        (_a = this.value) === null || _a === void 0 ? void 0 : _a.call(this, v);
        return this;
    };
    ...
    Default.prototype.formulaValue = function (value) { var _a; (_a = this._formula) === null || _a === void 0 ? void 0 : _a.value(this, value); };
    ...
    Default.prototype.hidden = function (v) { this._hidden = v === undefined ? true : v; return this; };
