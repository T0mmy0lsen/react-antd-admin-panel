...
export default class App extends React.Component<any, any> {
    ...
    constructor(props: any)
    {
        ...
        this.main = new Main(this, this.props.config, this.props.instance, this.props.account);
                ...
                { this.state.initiated && (
                    <Layout style={{ backgroundColor: 'transparent' }}>
                        ...
                        { this.state.modal
                            && (
                                <Modal
                                    ...
                                    cancelText={this.state.modal.cancelText ?? 'Cancel'}
                        ...
                        <Layout className="site-layout" style={{
                            ...
                            {!this.main.$config.config.hideHeader && this.getHeader()}
                            <Layout className="site-layout" key={ this.state.routeKey }>
                                <Row justify={'start'}>
                                    <Col span={24}>
                                        <Layout.Content style={{ overflow: 'auto', height: !!this.main.$config.config.hideHeader ? '100vh' : 'calc(100vh - 65px)' }}>
                                            <Routes>
