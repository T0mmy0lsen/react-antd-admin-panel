...
const Section = (props: {
    main: Main, section: any, form?: FormInstance, model?: SectionModel, parent?: any, style?: any, args?: any, updater?: any,
}) => {
    ...
    let [updater, setUpdater] = useState<any>(props.updater ?? 0);
