...
return new class extends Migration
{
    ...
    {
        Schema::create('formular_field_states', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('element_config_id')->nullable()->constrained('element_configs');
            $table->softDeletes();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('formular_field_states');
    }
};
