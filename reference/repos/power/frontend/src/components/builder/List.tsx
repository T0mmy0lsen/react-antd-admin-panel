    ...
    if (model._selectable) {
        addProps['rowSelection'] = {
            ...
            onChange: (selectedRowKeys: React.Key[], selectedRows: ListItem[]) => {
                ...
                model._selectableModel?.setValues(model._selectableFormat(selectedRows));
                // console.log(model._selectableModel)
            },
        ...
        <div style={model._style ?? {}}>
            <ConfigProvider renderEmpty={customizeRenderEmpty}>
                <Table
                    ...
                    pagination={props.model._footer ? {
                        pageSize: sourceData.p,
                        showSizeChanger: true,
                        locale: { items_per_page: '/ pr. side' }
                    } : false}
