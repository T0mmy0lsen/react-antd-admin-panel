...
var Get = /** @class */ (function (_super) {
    ...
    Get.prototype.finalize = function (response, args, callback, filename) {
        var _a, _b, _c, _d;
    ...
    Get.prototype.get = function (args, callback, filename) {
        var _this = this;
        if (args === void 0) { args = undefined; }
        if (callback === void 0) { callback = undefined; }
        if (filename === void 0) { filename = 'file.xlsx'; }
        ...
        axios_1.default[method](target, settings).then(function (response) {
            ...
            _this.finalize(response, args, callback, filename);
        })
            .catch(function (e) {
            var _a, _b, _c, _d, _e;
            if (!_this._mock) {
